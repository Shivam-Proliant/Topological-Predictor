# Project Antigravity: UPSC Topological Prediction Engine

Project Antigravity is an advanced, CPU-optimized predictive engine designed to forecast high-probability questions for the UPSC Civil Services Preliminary Examination. 
...
## 🧠 The Mathematics (The "Alien Math" Protocol)
...
*   **Adversarial Generation:** Local `Gemma 2B` via `llama.cpp` using Contrastive Prompting to generate multi-statement "Trap" questions.
